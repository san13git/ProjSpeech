...
const Home = () => {
  return (
    ...
    {/* <img src={speech} alt="Speech" style={{ width: '200px', height: '150px' }}/> */}
    <img
  src={speech}
  alt="Speech"
  style={{
    ...
    backgroundColor: '#FEFFD2', // Background color
    padding: '10px 0px', // Vertical padding 10px on top and bottom, 0px on sides
  }}
/>
